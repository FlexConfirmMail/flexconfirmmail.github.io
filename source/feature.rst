...
日々のメール送信時に起こりがちな誤送信を防止するために、実際の運用に合わせて必要な確認を行えるようにできます。
...
.. list-table::
   ...
   * - 宛先確認
     ...
     - .. figure:: _static/MainDialog.png
          :width: 95%
   * - BCCへの変換
     - To、Ccが一定数以上の場合に、BCCへの変換を促すことができます。宛先の数の閾値は設定可能です。
     - 
   * - 添付ファイルチェック
...
* 一般向け最新版　FlexConfirmMail: https://addons.thunderbird.net/ja/thunderbird/addon/flex-confirm-mail/
